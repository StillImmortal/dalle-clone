...
const CreatePost = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font-extrabold text-primary text-[32px]'>Create</h1>
        <p className='mt-2 text-secondary text-[16px] max-w-[500px]'>
          Create imaginative and visually stunning images through be DALL-E AI and share them with the community
        </p>
      </div>
